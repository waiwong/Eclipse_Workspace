...
//			connection = DriverManager.getConnection( "jdbc:hsqldb:hsql://localhost/bookdb", "sa", "" );
			...
			String SERVANDDB = "jdbc:mysql://localhost:3306/bookdb";
			String USER = "root";
			String PWD = "1234";

			Connection conn = (Connection) DriverManager.getConnection(SERVANDDB,
					USER, PWD);
			titlesQuery = conn.prepareStatement("SELECT isbn, title, editionNumber, "
