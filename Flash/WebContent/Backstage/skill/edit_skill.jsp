		...
		<div id="center-column">
			<div class="top-bar">
				...
				<div class="breadcrumbs">当前位置&gt;&gt;
				  <a href="../homepage.jsp">主页面</a> / 修改技巧信息</div>
			</div><br />
			...
			<div class="table">
				...
				<form name="ValidateForm" onSubmit="return checkValidateForm();" 
				      method=post action="SKILLINFO?sid=<%=sId%>">
                  <input type=hidden name=cmd value="editSkillInfo"> 
                  
				  <table class="listing form" cellpadding="0" cellspacing="0">                    
					<tr>
					  <th class="full" colspan="2">修改
