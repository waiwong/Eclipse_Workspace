	...
	<form action="querybooks.jsp" method="post">
		<table>
			<tr>
				...
				</select> Title Contains <input type=text name=title size=20>
			</tr>
			<tr>
				<td>Author Name Contains
				<td><input type=text size=20 name=author> Price From <input
					type=text name=fromprice size=10> To
				<td><input type=text name=toprice size=10>
			</tr>
		</table>
		<p>
			<input type=submit value="Query"> <a href="gohome.jsp">Home
				Page </a>
	</form>
	<%
